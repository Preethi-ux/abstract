...
<div class="row">
  <div class="col-xl-10 main-content pl-xl-4 pr-xl-5">
    ...
    <div class="example">
      <nav id="navbar-example1" class="navbar navbar-light border">
      ...
      <div data-spy="scroll" data-target="#navbar-example1" data-offset="0" class="scrollspy-example">
        <h4 id="fat">@fat</h4>
        <p>Ad leggings keytar, brunch id art party dolor labore. Pitchfork yr enim lo-fi before they sold out qui. Tumblr farm-to-table bicycle rights whatever. Anim keffiyeh carles cardigan. Velit seitan mcsweeney's photo booth 3 wolf moon irure. Cosby sweater lomo jean shorts, williamsburg hoodie minim qui you probably haven't heard of them et cardigan trust fund culpa biodiesel wes anderson aesthetic. Nihil tattooed accusamus, cred irony biodiesel keffiyeh abstract ullamco consequat.</p>
        <h4 id="mdo">@mdo</h4>
    ...
    <div class="example">
      <div class="row">
        <div class="col-6 col-md-3">
          <nav id="navbar-example3" class="navbar navbar-light border flex-column">
            <a class="navbar-brand" href="#">Navbar</a>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><nav id="navbar-example3" class="navbar navbar-light border">
  <a class="navbar-brand" href="#">Navbar</a>
  <nav class="nav nav-pills flex-column">
...
<div data-spy="scroll" data-target="#navbar-example3" data-offset="0">
  ...
  <p>...</p>
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#NestedNav"><i data-feather="copy"></i></button>
    </figure>
...
<div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
  ...
  <p>...</p>
      ...
      <button type="button" class="btn btn-clipboard" data-clipboard-target="#ListGroup"><i data-feather="copy"></i></button>
    </figure>
